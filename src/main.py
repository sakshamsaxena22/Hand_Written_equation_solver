...
# ✅ Ensure src is on sys.path when running main.py from project root
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
SRC_DIR = os.path.join(CURRENT_DIR, "src")
if SRC_DIR not in sys.path:
    sys.path.insert(0, SRC_DIR)

# Import all components from src
from core.preprocessor import AdvancedImagePreprocessor
from core.segmentation import MathExpressionSegmenter
from models.transformer_ocr import MathTransformerOCR
from core.parser import MathExpressionParser, EquationTypeClassifier
from solvers.symbolic_solver import SymbolicMathSolver
from output.latex_generator import LaTeXGenerator
from solvers.step_solver import StepByStepSolver
from utils.context_recognizer import ContextAwareRecognizer
